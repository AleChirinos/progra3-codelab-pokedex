...
public class PokemonUtils {
    ...
    public static List<Pokemon> getPokemons() {
        ...
        pokemons.add(new Pokemon(13, "Charmeleon", R.drawable.charmeleon, "Fire"));
        pokemons.add(new Pokemon(14, "Clefairy", R.drawable.clefairy, "Normal"));
        pokemons.add(new Pokemon(15, "Dewgong", R.drawable.dewgong, "Water"));
        pokemons.add(new Pokemon(16, "Doudo", R.drawable.doduo, "Normal"));
        pokemons.add(new Pokemon(17, "Grimer", R.drawable.grimer, "Poison"));
        pokemons.add(new Pokemon(18, "Haunter", R.drawable.haunter, "Ghost"));
        pokemons.add(new Pokemon(19, "Jigglypuff", R.drawable.jigglypuff, "Normal"));
        pokemons.add(new Pokemon(20, "Machop", R.drawable.machop, "Fight"));
        pokemons.add(new Pokemon(21, "Poiwag", R.drawable.poliwag, "Water"));
        pokemons.add(new Pokemon(22, "Ponyta", R.drawable.ponyta, "Fire"));
        pokemons.add(new Pokemon(23, "Psyduck", R.drawable.psyduck, "Normal"));
        pokemons.add(new Pokemon(24, "Slowpoke", R.drawable.slowpoke, "Water"));
